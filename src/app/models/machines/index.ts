...
import { FlowRateMachine } from '../FlowRateMachine';

// Batch machines (affected by speed upgrades)
...
// Flow-rate machines (per-mB ratio, count=1)

export function createChemicalInfuserSO3(): FlowRateMachine {
  const c = PRODUCTION_CHAIN.CHEMICAL_INFUSER_SO3;
  return new FlowRateMachine(
    'Chemical Infuser (SO\u2083)',
...
export function createRotaryCondensentrator(): FlowRateMachine {
...
export function createChemicalInfuserH2SO4(): FlowRateMachine {
...
export function createElectrolyticSeparator(): FlowRateMachine {
...
export function createChemicalInfuserUF6(): FlowRateMachine {
...
export function createIsotopicCentrifuge(): FlowRateMachine {
